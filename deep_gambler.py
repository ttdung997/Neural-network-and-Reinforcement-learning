...
class DeepGambler:
    ...
    def define_model(self):
        ...
        # fc1 = tf.layers.dense(self.model_input, 128, activation=tf.sigmoid, kernel_initializer=tf.constant_initializer(np.zeros((self.input_count, 64))))
        # fc2 = tf.layers.dense(fc1, 128, activation=tf.sigmoid, kernel_initializer=tf.constant_initializer(np.zeros((64, self.output_count))))
